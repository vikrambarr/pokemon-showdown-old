...
export const Moves: {[moveid: string]: MoveData} = {
	...
	courtchange: {
		...
		onHitField(target, source) {
			const sideConditions = [
				'mist', 'lightscreen', 'reflect', 'spikes', 'safeguard', 'tailwind', 'toxicspikes', 'permafrost', 'livewire', 'stealthrock', 'stealthcoal', 'waterpledge', 'firepledge', 'grasspledge', 'stickyweb', 'auroraveil', 'gmaxsteelsurge', 'gmaxcannonade', 'gmaxvinelash', 'gmaxwildfire',
			];
			let success = false;
	...
	defog: {
		...
		onHit(target, source, move) {
			...
			const removeTarget = [
				'reflect', 'lightscreen', 'auroraveil', 'safeguard', 'mist', 'spikes', 'toxicspikes', 'permafrost', 'livewire', 'permafrost', 'livewire', 'stealthrock', 'stealthcoal', 'stickyweb', 'gmaxsteelsurge',
			];
			const removeAll = [
				'spikes', 'toxicspikes', 'permafrost', 'livewire', 'stealthrock', 'stealthcoal', 'stickyweb', 'gmaxsteelsurge',
			];
	...
	gmaxwindrage: {
		...
		self: {
			onHit(source) {
				let success = false;
				const removeTarget = [
					'reflect', 'lightscreen', 'auroraveil', 'safeguard', 'mist', 'spikes', 'toxicspikes', 'permafrost', 'livewire', 'stealthrock', 'stealthcoal', 'stickyweb',
				];
				const removeAll = ['spikes', 'toxicspikes', 'permafrost', 'livewire', 'stealthrock', 'stealthcoal', 'stickyweb', 'gmaxsteelsurge'];
				for (const targetCondition of removeTarget) {
	...
	mortalspin: {
		...
		onAfterHit(target, pokemon) {
			...
			const sideConditions = ['spikes', 'toxicspikes', 'permafrost', 'livewire', 'stealthrock', 'stealthcoal', 'stickyweb', 'gmaxsteelsurge'];
		...
		onAfterSubDamage(damage, target, pokemon) {
			...
			const sideConditions = ['spikes', 'toxicspikes', 'permafrost', 'livewire', 'stealthrock', 'stickyweb', 'gmaxsteelsurge'];
			for (const condition of sideConditions) {
				if (pokemon.hp && pokemon.side.removeSideCondition(condition)) {
					this.add('-sideend', pokemon.side, this.dex.conditions.get(condition).name, '[from] move: Mortal Spin', '[of] ' + pokemon);
				}
	...
	tidyup: {
		...
		onHit(pokemon) {
			...
			const removeAll = ['spikes', 'toxicspikes', 'permafrost', 'livewire', 'stealthrock', 'stickyweb', 'gmaxsteelsurge'];
