...
export const Formats: FormatList = [
	...
	},
	{
		...
		banlist: ['ND Uber', 'ND AG', 'ID AG', 'Arena Trap', 'Moody', 'Power Construct', 'Shadow Tag', 'King\'s Rock', 'Quick Claw', 'Razor Fang', 'Assist', 'Baton Pass'],
	},
	{
		...
		banlist: ['ND AG', 'ID AG', 'Assist', 'Baton Pass'],
	},
	{
